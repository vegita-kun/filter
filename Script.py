...
<b>🔋 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ - <a href=https://t.me/Princeny4>Levi</b></a>"""
    
    HELP_TXT = """<b>ʜᴇʏ {},
ᴡᴇ ʜᴀᴠᴇ ᴅᴇᴠɪᴅᴇᴅ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅꜱ ꜰᴏʀ ɢʀᴏᴜᴘ ᴏᴡɴᴇʀꜱ ᴀɴᴅ ʙᴏᴛ ᴜꜱᴇʀꜱ.</b>"""

    
    BLACKLIST = ['@Ongoing_Paradox', 'Ongoing_Paradox', 'tamilblaster', 'filmyzilla', 'streamershub', 'xyz', 'cine', 'www', 'http', 'https',
...
‣ ᴄʀᴇᴀᴛᴏʀ : <a href=https://t.me/Princeny4>Levi</a>
‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ
‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ
‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ
‣ ʜᴏsᴛᴇᴅ ᴏɴ  : ʜᴇʀᴏᴋᴜ
...
★ Mᴇssᴀɢᴇ <code>{}</code>"""
    ...
    CAPTION = """
f"<blockquote>⍟ ғɪʟᴇ ɴᴀᴍᴇ : @Netflix_Dual - {file_caption}</blockquote>"
...
🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href=https://t.me/Princeny4>Levi</a>"""
...
💵 ᴜᴘɪ ɪᴅ - <code>princepanch34@okhdfcbank</code>
